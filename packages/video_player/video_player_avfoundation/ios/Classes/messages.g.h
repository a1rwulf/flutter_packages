...
@class FLTDownloadUrlMessage;
@class FLTDownloadMessage;
...
@property(nonatomic, strong, nullable) NSNumber * percentDownloaded;
...
- (void)startDownload:(FLTDownloadUrlMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
- (void)stopDownload:(FLTDownloadUrlMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
- (void)removeDownload:(FLTDownloadUrlMessage *)msg error:(FlutterError *_Nullable *_Nonnull)error;
- (void)getDownload:(FLTDownloadUrlMessage *)url completion:(void (^)(FLTDownloadMessage *_Nullable, FlutterError *_Nullable))completion;
- (void)initializeDownloadEvents:(FlutterError *_Nullable *_Nonnull)error;
@end
