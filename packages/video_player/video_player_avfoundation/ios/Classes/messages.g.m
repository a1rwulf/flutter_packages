...
@interface FLTDownloadUrlMessage ()
+ (FLTDownloadUrlMessage *)fromList:(NSArray *)list;
+ (nullable FLTDownloadUrlMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end

@interface FLTDownloadMessage ()
+ (FLTDownloadMessage *)fromList:(NSArray *)list;
+ (nullable FLTDownloadMessage *)nullableFromList:(NSArray *)list;
- (NSArray *)toList;
@end
...
+ (nullable FLTDownloadUrlMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTDownloadUrlMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
...
@implementation FLTDownloadMessage
+ (instancetype)makeWithUrl:(nullable NSString *)url
    state:(nullable NSNumber *)state
    percentDownloaded:(nullable NSNumber *)percentDownloaded
    bytesDownloaded:(nullable NSNumber *)bytesDownloaded {
  FLTDownloadMessage* pigeonResult = [[FLTDownloadMessage alloc] init];
  pigeonResult.url = url;
  pigeonResult.state = state;
  pigeonResult.percentDownloaded = percentDownloaded;
...
+ (FLTDownloadMessage *)fromList:(NSArray *)list {
  ...
  pigeonResult.percentDownloaded = GetNullableObjectAtIndex(list, 2);
  pigeonResult.bytesDownloaded = GetNullableObjectAtIndex(list, 3);
  return pigeonResult;
}
+ (nullable FLTDownloadMessage *)nullableFromList:(NSArray *)list {
  return (list) ? [FLTDownloadMessage fromList:list] : nil;
}
- (NSArray *)toList {
  return @[
    (self.url ?: [NSNull null]),
    (self.state ?: [NSNull null]),
    (self.percentDownloaded ?: [NSNull null]),
    (self.bytesDownloaded ?: [NSNull null]),
  ];
}
@end
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 129: 
      return [FLTDownloadMessage fromList:[self readValue]];
    case 130: 
      return [FLTDownloadUrlMessage fromList:[self readValue]];
    case 131: 
...
- (void)writeValue:(id)value {
  ...
  } else if ([value isKindOfClass:[FLTDownloadMessage class]]) {
    [self writeByte:129];
    [self writeValue:[value toList]];
  } else if ([value isKindOfClass:[FLTDownloadUrlMessage class]]) {
    [self writeByte:130];
    [self writeValue:[value toList]];
...
void FLTAVFoundationVideoPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FLTAVFoundationVideoPlayerApi> *api) {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.startDownload"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(startDownload:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(startDownload:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTDownloadUrlMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api startDownload:arg_msg error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.stopDownload"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(stopDownload:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(stopDownload:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTDownloadUrlMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api stopDownload:arg_msg error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.removeDownload"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(removeDownload:error:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(removeDownload:error:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTDownloadUrlMessage *arg_msg = GetNullableObjectAtIndex(args, 0);
        FlutterError *error;
        [api removeDownload:arg_msg error:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.getDownload"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(getDownload:completion:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(getDownload:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray *args = message;
        FLTDownloadUrlMessage *arg_url = GetNullableObjectAtIndex(args, 0);
        [api getDownload:arg_url completion:^(FLTDownloadMessage *_Nullable output, FlutterError *_Nullable error) {
          callback(wrapResult(output, error));
        }];
      }];
    } else {
  ...
  }
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:@"dev.flutter.pigeon.AVFoundationVideoPlayerApi.initializeDownloadEvents"
        binaryMessenger:binaryMessenger
        codec:FLTAVFoundationVideoPlayerApiGetCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(initializeDownloadEvents:)], @"FLTAVFoundationVideoPlayerApi api (%@) doesn't respond to @selector(initializeDownloadEvents:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        FlutterError *error;
        [api initializeDownloadEvents:&error];
        callback(wrapResult(nil, error));
      }];
    } else {
      [channel setMessageHandler:nil];
